...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '知名游资', link: '/游资/' },
      { text: '短线交易学习', link: '/学习路线/' },
      { text: 'AI答疑解惑', link: '/AI答疑解惑/' }
    ],
      ...
      '/学习路线/': [
        {
          text: '短线交易学习路线',
          items: [
            { text: '学习路线首页', link: '/学习路线/' },
            { text: '第一阶段：夯实核心基础知识', link: '/学习路线/第一阶段' },
            { text: '第二阶段：模拟交易验证策略', link: '/学习路线/第二阶段' },
            { text: '第三阶段：小资金实盘试炼', link: '/学习路线/第三阶段' },
            { text: '第四阶段：进阶优化与长期沉淀', link: '/学习路线/第四阶段' },
            { text: '学习资源推荐', link: '/学习路线/学习资源' },
            { text: '常见误区与注意事项', link: '/学习路线/常见误区' }
          ]
        }
      ],
      '/AI答疑解惑/': [
        {
          text: 'AI答疑解惑',
          items: [
            { text: '问题列表', link: '/AI答疑解惑/' },
            { text: '1. 短线离场和进场信号', link: '/AI答疑解惑/短线离场和进场信号' },
            { text: '2. 题材爆发和结束信号', link: '/AI答疑解惑/题材爆发和结束信号' },
            { text: '3. 每日复盘内容', link: '/AI答疑解惑/每日复盘内容' },
            { text: '4. 开盘竞价超预期判断', link: '/AI答疑解惑/开盘竞价超预期判断' },
            { text: '5. K线图看出三方行为', link: '/AI答疑解惑/K线图看出三方行为' },
            { text: '6. 判断资金性质', link: '/AI答疑解惑/判断资金性质' },
            { text: '7. 换手率健康标准', link: '/AI答疑解惑/换手率健康标准' },
            { text: '8. 主力持仓计算', link: '/AI答疑解惑/主力持仓计算' }
          ]
        }
      ]
    },
